...
_FEAT_ART = [
    ...
    # 7 verified citations: bib entry with a verified shield
    f"""<svg viewBox='0 0 160 64' aria-hidden='true'><rect x='12' y='10' width='88' height='44' rx='8' fill='var(--card)' stroke='var(--line)'/><text x='22' y='34' font-family='Georgia,serif' font-size='18' fill='{_A}'>@</text><rect x='42' y='20' width='48' height='5' rx='2.5' fill='{_M}' opacity='.55'/><rect x='22' y='40' width='68' height='5' rx='2.5' fill='{_M}' opacity='.35'/><path d='M126 12 L144 19 V31 C144 42 136 49 126 53 C116 49 108 42 108 31 V19 Z' fill='{_A}'/><path d='M118 32 l6 6 l11 -12' stroke='#fff' stroke-width='3' fill='none' stroke-linecap='round' stroke-linejoin='round'/></svg>""",
    # 8 checkpoints/undo: history clock + version timeline, newest highlighted
    f"""<svg viewBox='0 0 160 64' aria-hidden='true'><circle cx='52' cy='32' r='21' fill='none' stroke='{_A}' stroke-width='4'/><path d='M52 20 V32 L62 38' fill='none' stroke='{_A}' stroke-width='4' stroke-linecap='round' stroke-linejoin='round'/><line x1='112' y1='14' x2='112' y2='50' stroke='{_M}' stroke-width='3' opacity='.4'/><circle cx='112' cy='15' r='5' fill='{_M}' opacity='.5'/><circle cx='112' cy='32' r='5' fill='{_M}' opacity='.5'/><circle cx='112' cy='49' r='8' fill='{_A}'/><path d='M108.5 49 l2.5 2.5 l5 -5.5' stroke='#fff' stroke-width='2.2' fill='none' stroke-linecap='round' stroke-linejoin='round'/></svg>""",
    # 9 reviewer-ready: tracked-changes page sent off (paper plane)
